...
数据解析、程序实现及文稿整理使用 OpenAI Codex 辅助，队伍确认使用的模型为 GPT 5.6 SOL 和 GPT 6，另使用 Claude\cite{AICodex,AIClaude}。具体版本日期、Claude 的参与范围及人工复核记录见附录工具使用说明。
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{figures/图5-1_输入图结构与资源特征.pdf}
