...
\bibitem{AICodex} OpenAI，Codex 辅助工具；队伍确认的模型为 GPT 5.6 SOL、GPT 6，具体版本标识与发布日期待按使用记录核实，使用时间：2026 年 9 月。
\bibitem{AIClaude} Anthropic，Claude 人工智能工具，具体型号、版本发布日期与参与环节待队伍核实，使用时间：2026 年 9 月。
\end{thebibliography}
